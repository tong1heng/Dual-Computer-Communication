...
void client::on_connectButton_clicked() {
    ...
    //向服务器发出连接请求
    if(::connect(sockClient, (struct sockaddr*)&addrSrv, sizeof(addrSrv)) == INVALID_SOCKET || ::connect(sockClientFile, (struct sockaddr*)&addrSrvFile, sizeof(addrSrvFile)) == INVALID_SOCKET) {
